...
fetch("https://raw.githubusercontent.com/sammigachuhi/geojson_files/main/counties_sanitation.json")
    .then((response) =>{
...
info.update = function (props) {
    this.div.innerHTML = '<h4>Kenya Population Density</h4>' + (props ? 
        '<b>' + props.ADM1_EN + '</br><br>' + 'Total Population' + '</b><br>' + props.County_pop + '<br><br>' + '<b>' +
        "% Distribution of Conventional households with access to Main Sewer" + '</b><br>' + props.Human_waste_disposal : 'Hover over state');
};
